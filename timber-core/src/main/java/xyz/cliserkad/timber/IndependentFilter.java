 ...
 * Register with {@link FilterSet#add(IndependentFilter)}. At most one independent filter per concrete class is active;
 * registering a second instance of the same class replaces the first.
 */
